 ...
 * @version  $Id: class.soap_server.php 7541 2011-07-07 08:51:35Z gBrunier $
 * @access   public
 */
class nusoap_server extends nusoap_base
{
     ...
     * @param    mixed  $style         optional (rpc|document) or false Note: when 'document' is specified, parameter
     *                                 and return wrappers are created for you automatically
